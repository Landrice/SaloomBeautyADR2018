...
public class DBModel {
    ...
    public void createDataBase() {
        ...
        try {
            ...
            pst = con.mkDataBase().prepareStatement("CREATE TABLE if not exists "+db+".`Customerstype` (\n"
                    + "  `Id` int(11) NOT NULL AUTO_INCREMENT,\n"
                    + "  `CustomersType` VARCHAR(100) DEFAULT NULL,\n"                                       
                    + "  `CreatorId` int(11) DEFAULT NULL,\n"
                    + "  `Date` date,\n"
                    + "  `DiscountServices` VARCHAR(100) DEFAULT NULL,\n" 
                    + "  `DiscountProducts` VARCHAR(100) DEFAULT NULL,\n"
                    + "  PRIMARY KEY (`Id`),\n"
                    + "  UNIQUE INDEX `Id` (`Id` ASC));");
