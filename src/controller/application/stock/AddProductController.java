...
public class AddProductController implements Initializable {
    ...
    @FXML
    private JFXRadioButton productsradio;
    @FXML
    private ToggleGroup groupbtnt;
    @FXML
...
//        System.out.println(cbSupplyer.getPromptText());
    ...
    @FXML
    private void groupradioOnAction(ActionEvent event) {
        if (productsradio.isSelected() == true) {
            tfProductId.setText("PR-");
            cbSupplyer.setDisable(false);
            cmbBrand.setDisable(false);
            cmbCatagory.setDisable(false);
            cbRMA.setDisable(false);
        } else if (servicesradio.isSelected() == true) {
            tfProductId.setText("SV-");
            cbSupplyer.setDisable(true);
            cmbBrand.setDisable(true);
            cmbCatagory.setDisable(true);
            cbRMA.setDisable(true);
        }
    }
