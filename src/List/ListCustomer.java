...
public class ListCustomer {
    ...
    public ListCustomer(String id, String customerName, String customerContNo, String customerAddress, String totalBuy, String addBy, String addedDate,String customertype) {
        this.id = id;
